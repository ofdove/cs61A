...
def more_boar(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    while player_score // 10 >= 10:
        player_score = player_score // 10
    while opponent_score // 10 >= 10:
        opponent_score = opponent_score // 10
    second_leftmost_digit_opponent = opponent_score % 10
    leftmost_digit_opponent = opponent_score // 10 
    second_leftmost_digit_player = player_score % 10
    leftmost_digit_player = player_score // 10
    if second_leftmost_digit_opponent > second_leftmost_digit_player and leftmost_digit_opponent > leftmost_digit_player:
        return True
    else: 
        return False
    # END PROBLEM 4
    ...
    def say(score0, score1, last_score = last_score, running_high = running_high):
        if who == 0:
            if score0 - last_score > running_high:
                ...
                print("Player", who, "has reached a new maximun point gain.", running_high, "point(s)!")
            ...
            if score1 - last_score > running_high:
                ...
                print("Player {0} has reached a new maximun point gain. {1} point(s)!".format(who, running_high))
